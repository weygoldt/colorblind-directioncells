...
\myblock[MyBlock]{Preprocessing:}{
    ...
    \vspace{0.6cm}
    \textbf{2. Active ROIs:}
    Strongly autocorrelated ROIs across stimulus repeats are \glqq responding\grqq{}.
    \vspace{0cm}
    \begin{tikzfigure}[]
        \label{Rois}
...
\myblock[MyBlock]{2-photon calcium imaging}{
    ...
    \begin{itemize}
        \item Units responded to moving gratings of red and green 
        ...
        \item Points of zero achromatic contrast may correspond to lowest calcium activity.

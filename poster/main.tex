...
\myblock[MyBlock]{Regions of Interests (ROI)}{
    Region of Interests corrosponds to neurons with 
    ...
    \begin{tikzfigure}[]
        \label{Rois}
        \includegraphics[width=10cm]{figs/Screenshot 2022-11-17 at 19.05.14.png}
    \end{tikzfigure} 
   
    \vspace{0.85cm}
    \begin{tikzfigure}[]
        \label{Raw}
        \includegraphics[width=\linewidth]{figs/raw.pdf}
    \end{tikzfigure} 
    \vspace{0cm}

...
\myblock[MyBlock]{Preprocessing:}{
    ...
    corrosponds to neurons with genetically indueced calcium indicators. The lumiance $F$ of the calcium imaging is calculated from the change of luminance normalized to the average luminance $F = \frac{\Delta F}{F}$.
...
\myblock[MyBlock]{2-photon calcium imaging}{
    ...
    \begin{itemize}
        \item Calcium is activity was lowest, when the acromatic contrast was zero.
        \item Both directions CW and CCW were responing equally 
    \end{itemize}
...
\myblock[MyBlock]{Behavior}{
    ...
    \end{tikzfigure}
    \begin{itemize}
        \item The Optokietic response show similiar results as the calcium imaging.
    \end{itemize}
}
\myblock[MyBlock]{Conclusion}{
    \begin{itemize}
        \setlength\itemsep{0.5cm}
        We observed that the optic tectum of the zebrafish encodes for color directed motion stimulie.

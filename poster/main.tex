...
\myblock[MyBlock]{Preprocessing:}{
    ...
    \end{tikzfigure} 
    \vspace{0.6cm}
    \textbf{3. Active and direction-selective ROIs:} Strongly autocorrelated ROIs across stimulus repeats are \glqq responding\grqq{}, and 
    ROIs that correlated with a direction regressor (clockwise (CW) or counterclockwise (CCW)) are direction selective.

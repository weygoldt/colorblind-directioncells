...
class selective_rois_trash:
    def __init__(self, active_mean_dffs, active_mean_rois, active_mean_recs, corrs, thresh):

        # get active rois
        self.__all_dffs = active_mean_dffs
        self.__all_rois = active_mean_rois
        self.__all_recs = active_mean_recs
        self.__all_corrs = corrs
        self.thresh = thresh
